...
public class MiApp {
	...
	public static void main(String[] args) {
		...
		Cliente c1 = new Cliente("Miguel", new Date(), "2-2", "234234", "Modelo", 1, "Calle Lo Barnechea 54", "Lo Barnechea",
				35);
		...
		Cliente c2 = new Cliente("Juan", new Date(), "4-4", "234234", "Habitat", 0, "Calle Las Condes 123", "Las Condes",
				35);
